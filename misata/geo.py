...
_SUPPLEMENT: Dict[str, Tuple[float, float]] = {
    ...
    "Al Khor": (25.6839, 51.4989),
    "Umm Salal": (25.4167, 51.4000),
    "Lusail": (25.4300, 51.4900),
    "Al Daayen": (25.4667, 51.5333),
    "Mesaieed": (24.9911, 51.5470),
    "Dukhan": (25.4253, 50.7836),
    "Al Shamal": (26.1167, 51.2167),
    # United Arab Emirates (Dubai/Abu Dhabi already covered elsewhere)
    ...
    "Hawalli": (29.3328, 48.0263),
    "Al Ahmadi": (29.0769, 48.0839),
    "Al Farwaniyah": (29.2977, 47.9391),
    "Al Jahra": (29.3375, 47.6581),
    "Mubarak Al-Kabeer": (29.1740, 48.0740),
    "Salmiya": (29.3394, 48.0783),
    "Fahaheel": (29.0833, 48.1333),
    # Bahrain
    "Manama": (26.2285, 50.5860),
    "Riffa": (26.1300, 50.5550),
    "Muharraq": (26.2572, 50.6119),
    "Hamad Town": (26.1181, 50.5083),
    "A'ali": (26.1550, 50.5225),
    "Isa Town": (26.1742, 50.5478),
    "Sitra": (26.1550, 50.6350),
    "Budaiya": (26.2178, 50.4536),
    # Oman
    "Muscat": (23.5880, 58.3829),
    "Seeb": (23.6703, 58.1891),
    "Salalah": (17.0151, 54.0924),
    "Bawshar": (23.5709, 58.3986),
    "Sohar": (24.3474, 56.7091),
